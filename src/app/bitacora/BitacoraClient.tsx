          ...
          {!isEditing && mode !== 'create' && (
            <>
              <button onClick={() => logFull && generateBitacoraPdf(logFull, module, date, shift, config)}
                className="w-8 h-8 flex items-center justify-center rounded-xl bg-emerald-300 text-emerald-600 active:opacity-60 transition-opacity" aria-label="Descargar PDF">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
